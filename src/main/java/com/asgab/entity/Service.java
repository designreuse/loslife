...
public class Service {
  ...
  public String getDecodeCannotUseCard() {
    String value = getKeyValue("cannotUseCard");
    return "1".equals(value) ? "不可以" : "可以";
  }

  public String getDecodeNoDiscount() {
    String value = getKeyValue("noDiscount");
    return "1".equals(value) ? "不允许" : "允许";
  }

  public String getDecodeStored_in_shop() {
    String value = getKeyValue("stored_in_shop");
    return "1".equals(value) ? "保存" : "不保存";
  }
