...
<body>
	...
	<div style="padding: 10px;">
		...
		color: #333;pointer-events: auto;padding: 0; width: 100%;" border="1" >
			<tr style="font-size: 20px;">
				<td colspan=5 style="padding: 10px;">客户交易入账通知</td>
			</tr>
			<tr>
				<td style="padding: 8px; background: #ccc;">交易号：</td>
				<td style="padding: 8px; color: #666; " colspan=4>${tradeNo}</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td style="padding: 8px; color: #666;" colspan=4>${paymentRemark}</td>
			</tr>
			...
			<tr style="word-break: keep-all;white-space:nowrap; color: #666; ">
				<td style="padding: 8px; text-align: right;" colspan=2>总计(${currency})：</td>
				<td style="padding: 8px; text-align: right;" colspan=1>
	...
	<div style="padding: 10px;">
		...
		color: #333;pointer-events: auto;padding: 0; width: 100%;" border="1" >
			<tr style="font-size: 20px;">
				<td colspan=5 style="padding: 10px;">Customer Notice</td>
			</tr>
			<tr>
			...
			<tr style="word-break: keep-all;white-space:nowrap; background: #ccc;" >
				  ...
				  <td style="padding: 5px;">Top Up Amount（CNY）</td>
			</tr>
			...
			<tr style="word-break: keep-all;white-space:nowrap; color: #666; ">
				<td style="padding: 8px; text-align: right;" colspan=2>Total(${currency_en}):</td>
				<td style="padding: 8px; text-align: right;" colspan=1>
					<span>${totalAmount}</span>
				</td>
				<td></td>
